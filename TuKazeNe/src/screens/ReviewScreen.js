...
export default function ReviewScreen({ route, navigation }) {
  ...
  const submitReview = async () => {
    ...
    try {
      ...
      const reviewData = {
        ...
        reviewerName: 'Current User', // In real app, get from user profile
      };
  ...
  const updateWorkerRating = async (workerId) => {
    // In a real app, you'd calculate the new average rating
    // For now, we'll just mark that a review was added
